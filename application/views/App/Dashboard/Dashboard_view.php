                    ...
                    <div class="container-fluid">
                        ...
                        <!-- end page title --> 
                        <?php $member = $this->M_user->getallMember()->num_rows(); 
                        $paket = $this->db->get('tbl_paket')->num_rows();
                        $outlet = $this->db->get('tb_outlet')->num_rows();
                        $admin = $this->db->get_where('tb_user',['role' => 'admin'])->num_rows();
                        $kasir = $this->db->get_where('tb_user',['role' => 'kasir'])->num_rows();
                        $owner = $this->db->get_where('tb_user',['role' => 'owner'])->num_rows();
                        ?>
                        <div class="row">
                            <div class="col-12">
                                        ...
                                        <div class="row no-gutters">
                                            <div class="col-sm-6 col-xl-3">
                                                <div class="card shadow-none m-0">
                                                    <div class="card-body text-center">
                                                        ...
                                                        <h3><span><?php echo $paket; ?></span></h3>
                                                        <p class="text-muted font-15 mb-0">Total Paket Cucian</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6 col-xl-3">
                                                <div class="card shadow-none m-0 border-left">
                                                    <div class="card-body text-center">
                                                        <i class="uil-store text-muted" style="font-size: 24px;"></i>
                                                        <h3><span><?php echo $outlet; ?></span></h3>
                                                        <p class="text-muted font-15 mb-0">Total Outlet</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6 col-xl-3">
                                                <div class="card shadow-none m-0 border-left">
                                                    <div class="card-body text-center"><hr>
                                                        <i class="uil-user-circle text-muted" style="font-size: 24px;"></i>
                                                        <h5 class="text-center">Management User</h5>
                                                        <div class="row">
                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                <h3><span><?php echo $admin; ?></span></h3>
                                                                <p class="text-muted font-15 mb-0">Admin</p>
                                                            </div>
                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                <h3><span><?php echo $kasir; ?></span></h3>
                                                                <p class="text-muted font-15 mb-0">Kasir</p>
                                                            </div>
                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                <h3><span><?php echo $owner; ?></span></h3>
                                                                <p class="text-muted font-15 mb-0">Owner</p>
                                                            </div>
                                                        </div> 
                                                    </div>
                                                </div>
