...
;(function(root) {
	...
	var TABLE = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789%2b/index.html';
...
!(__WEBPACK_AMD_DEFINE_RESULT__ = function (require) {
    ...
    return function module() {
        ...
        function cleanData(_ref11) {
            ...
            if (!dataByTopic && !data) {
                throw new Error('Data%20needs%20to%20have%20a%20dataByTopic%20or%20data%20property.%20See%20more%20in%20http_/eventbrite.github.io/britecharts/global.html#LineChartData__anchor');
            }
